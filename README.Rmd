...
The script "data_overview_reproducible.Rmd" can be reproduced via Binder by following the link to [Binder](https://mybinder.org/v2/gh/MLezamaValdes/SurfaceMoistureMDV/master?urlpath=rstudio), installing the required packages by running "install.R" and subsequently running the "data_overview_reproducible.Rmd" file. 
