...
The script "descriptive.Rmd" can be reproduced via Binder by following the link to [Binder](https://mybinder.org/v2/gh/MLezamaValdes/SurfaceMoistureMDV/master?urlpath=rstudio), opening the SurfaceMoistureMDV.Rproj project file and subsequently running the descriptive.Rmd file. 
