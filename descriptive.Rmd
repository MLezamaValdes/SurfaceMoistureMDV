...
* Airtemperature in degrees C, 
* Solar Radiation in W/m², 
* wind speed in mph, 
* temperature at 2cm depth in degrees C 
* the soil moisture content (wfv) 
* salinity in g NaCl/l 
* soil conductivity in Siemen (S/m)


### Station records that are different from the rest: 

* BullPass: 2009


### TO DO: RATHER PICK VARIABLES OUT THAT ARE INTERESTING?
...
# lapply(seq(sdirs), function(d){ # for all different stations
  f <- list.files(sdirs[d], full.names=T)
  ...
  # loop through all of the files
      ...
      tab <- read_excel(f[y], .name_repair="minimal",
                 skip=3, col_names = pastenams)
